...
Models imported from modeling software can contain multiple meshes. Meshes can share materials via material slots.
...
To disable merging for specific meshes, enable their corresponding **nodes**.
