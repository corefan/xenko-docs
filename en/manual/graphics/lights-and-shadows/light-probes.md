...
* At least one light probe must be on a different plane to the others. For example, the probes in the screenshot below don't work, as they are on a flat plane and create no volume.
