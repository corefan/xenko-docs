...
By default, rendering produces a very sharp image, which can look artificial. **Depth of field** effects simulate the behavior of a camera lens focusing on an object, leaving background and foreground objects blurred.

![media/realworld_dof_agave_flowers.jpg](media/realworld_dof_agave_flowers.jpg) 

Xenko achieves the effect by creating several versions of the original image with different intensities of blur, and interpolating between them. The more layers used, the better the quality, but at performance cost. 
